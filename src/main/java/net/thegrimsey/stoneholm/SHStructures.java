...
public class SHStructures {
    ...
    public static final RegistryObject<UnderGroundVillageStructure> UNDERGROUND_VILLAGE = STRUCTURE_DEFERRED_REGISTER.register("underground_village", () -> new UnderGroundVillageStructure(NoneFeatureConfiguration.CODEC));
